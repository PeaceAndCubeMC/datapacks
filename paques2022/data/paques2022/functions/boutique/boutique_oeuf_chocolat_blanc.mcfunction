...
execute if score @s oeufs >= #palierp1 oeufs if entity @s[scores={oeufs_money=15..}] run give @s ghast_spawn_egg{display:{Name:'{"text":"Oeuf en chocolat blanc","color":"#F5F5F7","bold":true,"italic":false}',Lore:['{"text":" "}','[{"text":"Pâques","color":"#3DA339","bold":true,"italic":false},{"text":" ●","color":"white","bold":false,"italic":false},{"text":" 2022","color":"#754939","bold":true,"italic":false}]']},EntityTag:{id:"minecraft:item",Item:{id:"minecraft:pumpkin_seeds",Count:3b,tag:{display:{Name:'{"text":"Pépites de chocolat blanc","color":"#F5F5F7","bold":true,"italic":false}',Lore:['{"text":" "}','[{"text":"Pâques","color":"#3DA339","bold":true,"italic":false},{"text":" ●","color":"white","bold":false,"italic":false},{"text":" 2022","color":"#754939","bold":true,"italic":false}]']}}}}} 1
