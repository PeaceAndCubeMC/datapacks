...
execute if score @s oeufs >= #palierp1 oeufs if entity @s[scores={oeufs_money=15..}] run give @s rabbit_spawn_egg{display:{Name:'{"text":"Oeuf en chocolat au lait","color":"#805230","bold":true,"italic":false}',Lore:['{"text":" "}','[{"text":"Pâques","color":"#3DA339","bold":true,"italic":false},{"text":" ●","color":"white","bold":false,"italic":false},{"text":" 2022","color":"#754939","bold":true,"italic":false}]']},EntityTag:{id:"minecraft:item",Item:{id:"minecraft:cocoa_beans",Count:3b,tag:{display:{Name:'{"text":"Pépites de chocolat au lait","color":"#B87654","bold":true,"italic":false}',Lore:['{"text":" "}','[{"text":"Pâques","color":"#3DA339","bold":true,"italic":false},{"text":" ●","color":"white","bold":false,"italic":false},{"text":" 2022","color":"#754939","bold":true,"italic":false}]']}}}}} 1
