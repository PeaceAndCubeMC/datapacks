execute if entity @s[scores={ete2022_quete=6},tag=!ete2022_hint3] run tellraw @s ["",{"text":"[","color":"dark_green"},{"text":"Été 2022","color":"green"},{"text":"] ","color":"dark_green"},{"selector":"@s","color":"blue"},{"text":" : ","color":"blue"},{"text":"Cette bannière, il me semble l'avoir vu dans le château de Lord O'Nance.","color":"white"}]

execute if entity @s[scores={ete2022_quete=6},tag=ete2022_hint3] unless entity @s[scores={ete2022_quete=6},tag=ete2022_hint1,tag=ete2022_hint2,tag=ete2022_hint3] run tellraw @s ["",{"text":"[","color":"dark_green"},{"text":"Été 2022","color":"green"},{"text":"] ","color":"dark_green"},{"selector":"@s","color":"blue"},{"text":" : ","color":"blue"},{"text":"J'ai déjà fouillé ici.","color":"white"}]

execute if entity @s[scores={ete2022_quete=6},tag=!ete2022_hint3] run scoreboard players add @s ete2022_hints 1

execute if entity @s[scores={ete2022_quete=6},tag=!ete2022_hint3] run tellraw @s ["",{"text":"[","color":"dark_green"},{"text":"Été 2022","color":"green"},{"text":" Indices trouvés ","color":"yellow"},{"score":{"name":"@s","objective":"ete2022_hints"},"color":"gold"},{"text":"/3","color":"gold"}]


execute if entity @s[scores={ete2022_quete=6},tag=!ete2022_hint3] run tag @s add ete2022_hint3
